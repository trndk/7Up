...
upload.modules.addmodule({
    ...
    template: '\
        ...
        <div class="viewswitcher">\
            <a id="newpaste" class="btn">Văn bản mới</a>\
        </div>\
        </div>\
    ...
    progress: function(e) {
        if (e.eventsource != 'encrypt') {
            this._.progress.type.text('Đang tải lên')
        } else {
            this._.progress.type.text('Đang mã hóa')
        }
    ...
    dopasteupload: function (data) {
        ...
        upload.textpaste.render(this._.view, 'Văn bản.txt', data, 'text/plain', this.closepaste.bind(this))
    },
