...
upload.modules.addmodule({
    ...
    template: '\
      <div class="modulecontent" id="dlarea">\
        ...
        <div class="viewswitcher">\
          <a id="editpaste" class="btn">Chỉnh sửa</a\
          ><a class="btn" id="newupload" href="#">Tải lên</a>\
        </div>\
        </div>\
        <div id="downloaddetails"></div>\
        <div id="btnarea">\
                <a class="btn" id="dlbtn" href="#">Tải về</a\
                ><a class="btn" id="inbrowserbtn" target="_blank" href="#">Xem ảnh</a\
                ><a class="btn" id="deletebtn" href="#">Xoá</a\
                ><div class="right"><a class="btn" id="prevbtn" href="#">Prev</a\
                ><a class="btn" id="nextbtn" href="#">Tiếp tục</a></div>\
        </div>\
      </div>\
    ',
    init: function () {
    ...
    downloaded: function (data) {
        ...
        if (association == 'image' || association == 'svg') {
            ...
            $('<div>').addClass('preview').addClass('downloadexplain centerable centertext').text("Nhấn vào link tải ở góc trái bên dưới để tải file.").appendTo(this._.detailsarea)
        }
    ...
    progress: function (e) {
        if (e == 'decrypting') {
            this._.content.loading.text('Đang giải mã')
        } else if (e == 'error') {
          this._.content.loading.text('Không thể tìm thấy file!')
          this._.newupload.show()
        } else {
            var text = ''
